...
library GameStates {
    ...
    /// @notice     Check if the contract is currently in the start state.
    /// @param _d   Deposit storage pointer.
    /// @return     True if contract is currently in the start state else False.
    function inStart(GameUtilsAndStruct.Game storage _d)
        external
        view
        returns (bool)
    {
    ...
    function inFunding(GameUtilsAndStruct.Game storage _d)
        external
        view
        returns (bool)
    {
        return (_d.currentState == uint8(States.CREATED));
    }
    ...
    function inEndState(GameUtilsAndStruct.Game storage _d)
        external
        view
        returns (bool)
    {
        return (_d.currentState == uint8(States.FINISHED));
    }
    ...
    function inRedeemableState(GameUtilsAndStruct.Game storage _d)
        external
        view
        returns (bool)
    {
    ...
    function inWaitingForStart(GameUtilsAndStruct.Game storage _d)
        external
        view
        returns (bool)
    {
    ...
    function setCreated(GameUtilsAndStruct.Game storage _d) external {
